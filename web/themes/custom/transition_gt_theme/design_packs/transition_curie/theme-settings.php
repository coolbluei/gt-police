 ...
 */
function trans_curie_form_system_theme_settings_alter(&$form, &$form_state)
{
    $form['core'] = array(
        '#type' => 'vertical_tabs',
  ...
  $form['options']['trans_curie'] = array(
    '#type' => 'details',
    '#attributes' => array(),
    '#title' => t('Georgia Tech Curie theme package'),
    '#description' => t('<p>Curie uses Georgia Tech Institute Communications-approved content customization to build and customize campus websites. See the <a href="https://theme.gatech.edu">Georgia Tech Theme demo website</a> for more information and documentation.</p>'),
    '#weight' => -1000,
    '#group' => 'options',
    '#open' => TRUE,
  );
  ...
  /*--------- Footer Contact Info ------------ */
    ...
    $form['footer_settings']['footer_first_size'] = array(
        '#type' => 'select',
    ...
    $form['footer_settings']['footer_second_size'] = array(
        '#type' => 'select',
    ...
    $form['footer_settings']['footer_third_size'] = array(
        '#type' => 'select',
    ...
    $form['footer_settings']['footer_four_size'] = array(
        '#type' => 'select',
